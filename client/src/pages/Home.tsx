...
const asset = {
  hero: "/manus-storage/control-plane-hero_c8abb376.jpg",
  architecture: "/manus-storage/infrastructure-architecture_fa1ffc0c.jpg",
  texture: "/manus-storage/observability-texture_bdf42214.jpg",
};
...
function TerminalCard() {
  ...
  const runCommand = (raw: string) => {
    ...
    switch (name.toLowerCase()) {
      ...
      case "resume": output = ["Opening resume..."]; window.open("/manus-storage/Sooraj_Poojary_Resume_efe1a1d5.pdf", "_blank"); break;
